 ...
 * 잠정 주문 처리
 */
export function on_tentative_order_project(client_env, project_id) {
 ...
 */
export function on_tentative_order_with_vdp(client_env, project_id) {
	console.log(project_id)
 ...
 * 확정 주문 처리
 */
export function on_definitive_order_project(client_env, project_id) {
    /*
 ...
 * 주문 취소 처리
 */
export function on_cancel_order_project(client_env, project_arr, project_id) {
	// console.log(project_id)
